            ...
            <div className="notification pb-5 d-md-none">
                ...
                <div>
                    <div>
                        ...
                        <div className="container">
                            <li style={{ color: `#${this.state.todos[0].color}`, fontWeight: "700" }} className="py-4 card-text fw-bolder">{this.state.todos[0].code}</li>
                            <p style={{ color: `#${this.state.todos[0].color}` }}>{this.state.recent[1].text}</p>
