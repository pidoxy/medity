            ...
            <div id="#features" className="App mt-3 d-md-block d-none">
                ...
                <div >
                    <div style={{ backgroundColor: `${this.props.blocks[1].color}` }} className="py-3 mt-5 px-5 text-center" >
                        ...
                        <div className="row">
                            <h1 className="py-5 col-4 text-center" style={{ color: 'white' }}>{this.props.blocks[1].title}</h1>
                            <p className="py-5 col-8 text-center " style={{ fontSize: '20px' }}>{this.props.blocks[1].text}</p>
                        </div>
                    </div>
                </div>
