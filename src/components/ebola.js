            ...
            <div className="notification pb-5 d-md-none">
                ...
                <div className="container">
                    ...
                    <p className="py-3">Click to learn more</p>
                        ...
                        {this.state.clicked1 ? (<div className="p-3">{this.props.ebola.symptoms.map((symptom, id) => <li key={id}>{symptom.text}</li>)}</div>) : null}
                    </div>
                    ...
                    <div className="px-3">
                        ...
                        {this.state.clicked2 ? (<div className="p-3">{this.props.ebola.prevention.map((prevention, id) => <li key={id}>{prevention.text}</li>)}</div>) : null}
